...
class FeedController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return inertia('Admin/Feeds/Index', [
            'feeds' => $feeds,
            'tenantId' => $tenantId,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return inertia('Admin/Feeds/Create', [
            'tenant' => $tenant ?? null,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.feeds.show', $feed)->with('success', 'Feed created successfully.');
    }
    ...
    public function show(string $id)
    {
        ...
        return inertia('Admin/Feeds/Show', [
            'feed' => $feed,
        ]);
    }
    ...
    public function edit(string $id)
    {
        ...
        return inertia('Admin/Feeds/Edit', [
            'feed' => $feed,
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.feeds.show', $feed)->with('success', 'Feed updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.feeds.index', ['tenant_id' => $tenantId])->with('success', 'Feed deleted successfully.');
    }
